...
# label  1
w = Label(root, text='HOME AUTOMATION',font=15,bg='goldenrod')
w.grid(row=0, column=1, columnspan=5, pady=30)

# label 2
Label(root, text='Relay 1', width=6, height=4,bg='gray30',
      fg='white').grid(row=1, column=1, pady=10, padx=5)

Label(root, text='Relay 2', width=6, height=4,bg='gray30',
      fg='white').grid(row=1, column=2, pady=10, padx=5)

Label(root, text='Relay 3', width=6, height=4, bg='gray30',
      fg='white').grid(row=1, column=3, pady=10, padx=5)

Label(root, text='Relay 4', width=6, height=4, bg='gray30',
      fg='white').grid(row=1, column=4, pady=10, padx=5)
...
button5 = Button(root, text='START ALL', command=onoff5, bg='green',fg='white')
...
Label(root, text='Developed by-', font=("Helvetica", 10, "bold italic")).grid(row=4, column=5)

sb = Label(root, image=sbc)
